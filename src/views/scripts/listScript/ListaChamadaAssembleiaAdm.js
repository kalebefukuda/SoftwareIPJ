document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Busca os dados e inicializa a tabela
    async function fetchData() {
        try {
            ...
            console.error('Erro ao carregar lista de assembleia de adm:', error);
        }
    }

    // Atualiza a tabela com os dados corretos
    ...
    document.getElementById('printBtn').addEventListener('click', () => {
        ...
        const title = "Lista de Chamada Assembleia ADM";
        ...
        while (currentDataIndex < data.length) {
            ...
            doc.autoTable({
                ...
                body: pageData.map(item => [item.NOME, '']),
                ...
                styles: {
                    ...
                    cellPadding: 3,
                    valign: 'middle',
                    halign: 'left',  // Alinha texto à esquerda
                    cellWidth: 'wrap'
                },
                headStyles: {
                    ...
                    fontStyle: 'bold',
                    halign: 'left',
                    cellPadding: { top: 3, right: 14, bottom: 3, left: 5 }
                },
                ...
                didDrawCell: (data) => {
                    if (data.column.index === 1 && data.cell.section === 'body') {
                        ...
                        const posX = cell.x;
                        const posY = cell.y + cellHeight - 2; // Adjust Y position to be within the cell
                        
                        // Draw the line for signature
                        doc.setDrawColor(0);
                        doc.setLineWidth(0.5);
                        doc.line(posX, posY, posX + cell.width, posY);
                    }
                },
        ...
        doc.save('lista de chamada assembleia adm.pdf');
    });
});
