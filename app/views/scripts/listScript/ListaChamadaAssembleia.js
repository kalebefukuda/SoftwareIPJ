...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('printBtn').addEventListener('click', () => {
        ...
        const title = "Lista de Chamada da Assembleia";
        ...
        doc.line(20, 40, 190, 40); // Ajustar a posição vertical da linha conforme necessário
        ...
        while (currentDataIndex < data.length) {
            ...
            doc.autoTable({
                ...
                columns: [
                    ...
                    { header: 'Local Residencia', dataKey: 'local_residencia' },
                ],
