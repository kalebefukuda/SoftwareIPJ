document.addEventListener('DOMContentLoaded', async () => {
    ...
    let data = [];
    const tbody = document.getElementById('listacomunmas');
    ...
    async function fetchData() {
        try {
            const response = await fetch('/api/lista-comungantes-mas');
            ...
            console.error('Erro ao carregar lista de comungantes masculino:', error);
        }
    }
    ...
    document.getElementById('printBtn').addEventListener('click', () => {
        ...
        const title = "Lista de Comungantes - Masculino";
        ...
        doc.save('lista de comungantes masculino.pdf');
    });
});
