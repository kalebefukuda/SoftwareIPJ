document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function fetchData() {
        try {
            ...
            console.error('Erro ao carregar lista de não comungantes feminino:', error);
        }
    }
    ...
    document.getElementById('printBtn').addEventListener('click', () => {
        ...
        const title = "Lista de não comungantes - Feminino";
        ...
        doc.save('lista de não comungantes feminino.pdf');
    });
});
