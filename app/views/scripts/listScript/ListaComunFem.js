document.addEventListener('DOMContentLoaded', async () => {
    ...
    let data = [];
    const tbody = document.getElementById('listacomunfem');
    ...
    async function fetchData() {
        try {
            const response = await fetch('/api/lista-comungantes-fem');
    ...
    document.getElementById('printBtn').addEventListener('click', () => {
        ...
        const title = "Lista de Comungantes - Feminino";
        ...
        doc.save('lista de comungantes feminino.pdf');
    });
});
