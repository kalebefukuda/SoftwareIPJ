...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('printBtn').addEventListener('click', () => {
        ...
        const title = "Lista de datas de casamento";
        ...
        const itemsPerPageFirstPage = 15;
        const itemsPerPageOtherPages = 17;
        ...
        while (currentDataIndex < data.length) {
            ...
            doc.autoTable({
                ...
                columns: [
                    { header: 'Data de Casamento', dataKey: 'DATA_CASAMENTO' },
                    { header: 'Casal', dataKey: 'CASAL' },
                    { header: 'Anos de Casamento', dataKey: 'ANOS_CASAMENTO' }
                ],
        ...
        doc.save('datas de casamento.pdf');
    });
});
