...
// router.get('/:id', SociedadeInternaController.obter);

// // Criar uma nova sociedade interna
// router.post('/', SociedadeInternaController.criar);

// // Atualizar uma sociedade interna existente
// router.put('/:id', SociedadeInternaController.atualizar);

// // Excluir uma sociedade interna
// router.delete('/:id', SociedadeInternaController.excluir);
